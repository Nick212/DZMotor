<%@ Page Title="" Language="C#" MasterPageFile="~/View/MasterPageAnalyzer.Master" AutoEventWireup="true" CodeBehind="BuscarUsuario.aspx.cs" Inherits="DzAnalyzer.View.Cadastro.BuscarUsuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 1500px; height: 1000px;">
        <div style="width: 600px; height: 400px; float: left;">
            ...
            <asp:TextBox ID="TextBox15" onkeypress="return VerificaNumero(event);" runat="server" Width="331px" CssClass="form-control"></asp:TextBox><br />
            <br />
            <br />
            <asp:Button Text="BUSCAR" onkeypress="return VerificaString(event);" runat="server" OnClientClick="return ValidaBusca3();" ID="btnBuscar1" Height="41px" OnClick="btnBuscar1_Click" Width="125px" CssClass="btn btn-primary" />
            <br />
        </div>
        <div style="width: 600px; height: 400px; float: left;">
            <asp:Label ID="Label14" runat="server" Text="Label">NOME</asp:Label><br />
            <asp:TextBox ID="TextBox16" onkeypress="return VerificaString(event);" runat="server" Width="385px" CssClass="form-control"></asp:TextBox><br />
            <br />
            <br />
            <asp:Button Text="BUSCAR" runat="server" OnClientClick="return ValidaBusca4();" ID="btnBuscar2" OnClick="btnBuscar2_Click" Height="41px" Width="125px" CssClass="btn btn-primary" />
        </div>

        <asp:GridView ID="GridView1" runat="server" Height="358px" Width="809px" CssClass="table table-hover table-striped" GridLines="None" AllowPaging="True"></asp:GridView>
    </div>
